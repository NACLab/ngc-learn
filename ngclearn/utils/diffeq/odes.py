...
def oscillator(t, x, params, mu1=0.05, mu2=-0.01, omega=3.0, alpha=-2.0, beta=-5.0, sigma=1.1):
    ...
    dz = mu2 * z_ - (omega + alpha * y_ + beta * z_) * y_
...
if __name__ == "__main__":
    ...
    t, x_lorenz = solve_ode('rk4', t0=t0, x0=x0, T=2000, dfx=lorenz_model, dt=dt, params=None, sols_only=True)
    # 4. Linear 3D System
