...
class MSTDPETDeconvSynapse(TraceSTDPDeconvSynapse): ## modulated trace-based deconv STDP cable
    """
    A synaptic deconvolutional (tranposed convolutional) cable that adjusts its
