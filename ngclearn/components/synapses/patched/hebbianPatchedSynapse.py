...
class HebbianPatchedSynapse(PatchedSynapse):
    ...
    # Define Functions
    def __init__(self, name, shape, model_shape=(1,1), eta=0., weight_init=None, bias_init=None,
        ...
        super().__init__(name, shape, model_shape, weight_init, bias_init, resist_scale,
...
if __name__ == '__main__':
    ...
    with Context("Bar") as bar:
        Wab = HebbianPatchedSynapse("Wab", (2, 3), 0.0004, optim_type='adam',
