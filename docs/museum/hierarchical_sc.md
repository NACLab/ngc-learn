...
$$
\frac{d\mathbf{r}}{dt} = -\frac{k_1}{2}\frac{\partial \mathbf{E}{\partial \mathbf{r}} = \frac{k_1}{\sigma^2} \mathbf{U}^T \frac{\partial f^T}{\partial \mathbf{x}} (\mathbf{I} - f(\mathbf{U}\mathbf{r})) + \frac{k_1}{\sigma_{td}^2}(\mathbf{r}^{td} - \mathbf{r}) - \frac{k_1}{2} g'(\mathbf{r})
$$
